<?php
/**
 * wonking-theme functions and definitions
 *
...
function wonking_setup() {
	 ...
	 * If you're building a theme based on wonking-theme, use a find and replace
	...
	add_image_size('large-thumb', 1060, 350, true);
